    ...
    <footer className="border-t border-border bg-primary py-10 text-primary-foreground">
      ...
      <div className="container-tight flex flex-col items-center justify-between gap-4 md:flex-row">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="grid h-7 w-7 place-items-center rounded-md bg-[hsl(var(--accent))]">
        ...
        <p className="text-xs text-primary-foreground/60">
          ...
          {block?.body ||
            ...
            `Built in AI Web Session 2026, ClearContent CMS, Student: Anne Dorcas Nguewouo, Team: TEAM_SLUG`
